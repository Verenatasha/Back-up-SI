...
if ( isset ($_POST["ubah"])) {
	...
	$ubah = mysqli_query($conn, "UPDATE kelas SET kelas = '$kelas', file = '$file', imgDesk = '$imgDesk' WHERE id_kelas = '$id_kelas' ");
	if ($ubah) {
		echo "
			<script>
				alert('Data berhasil diubah!');
				document.location.href = 'admin_page.php#kelas';
			</script>
		";
	} else {
		echo "
	...
	<body>
		...
		<article>
			<div class="container mb-5">
				<div class="card">
					<div class="card-header bg-danger text-white">Ubah Kelas</div>
					<div class="card-body">
							...
							<div class="container">
								<div class="row">
									...
									<div class="col mb-5">
										...
										<input type="text" class="form-control mb-3" name="imgDesk" placeholder="Keterangan gambar" value="<?php echo $row["imgDesk"]; ?>" maxlength="121">
									</div>
									<?php endwhile; ?>
								</div>
